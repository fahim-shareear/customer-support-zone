            ...
            <div className="card-container bg-white rounded-2xl cursor-pointer">
                <div className="card_body m-3">
                    <div className="title flex justify-between items-center">
                        <h1 className="text-black font-medium text-[13px]">{u.title}</h1>
                    ...
                    <div className="flex justify-between items-center">
                        <div className="flex justify-between items-center gap-5 p-2">
                            ...
                            <h3 className="text-black font-bold uppercase text-[12px]">{u.priority}</h3>
                        </div>
                        <div className="flex justify-between items-center gap-5 p-2">
                            <h3 className="text-black font-bold capitalize text-[12px]">{u.createdBy}</h3>
                            <h3 className="text-black font-bold text-[12px]">{u.createdAt}</h3>
                        </div>
                    </div>
                </div>
            </div>
